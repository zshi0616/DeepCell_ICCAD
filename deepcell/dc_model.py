...
class Model(nn.Module):
    ...
    def __init__(self, 
        ...
        if self.aggr == 'dg':
            ...
            self.aggr_cell_strc = AggConv(self.dim_hidden*1, self.dim_hidden)
            self.aggr_cell_func = AggConv(self.dim_hidden*2, self.dim_hidden)
        elif self.aggr == 'gat':
            self.aggr_cell_strc = AGNNConv(self.dim_hidden*1, self.dim_hidden)
            self.aggr_cell_func = AGNNConv(self.dim_hidden*2, self.dim_hidden)
